...
import br.com.cybergames.backend.service.ProdutoImagensService;
...
public class ProdutoImagensController {
    ...
    @PostMapping("/")
    public ProdutoImagens inserir(@RequestParam("idProduto") Long idProduto, @RequestParam("file") MultipartFile file, ProdutoImagens produtoImagens){
